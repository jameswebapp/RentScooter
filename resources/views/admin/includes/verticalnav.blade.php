...
<div class="vertical-navigations animated">
    <ul class="side-nav fixed animated collapsible collapsible-accordion" id="nav-default">
        ...
        <li>
            <a class="collapsible-header no-col-body waves-effect waves-set" href="{{ url('/admin/user') }}">
                <i class="material-icons">dashboard</i>
                <span>User</span>
            </a>
        </li>
        <li>
            <a class="collapsible-header no-col-body waves-effect waves-set" href="{{ url('/admin/scooter') }}">
                <i class="material-icons">dashboard</i>
                <span>Scooter</span>
            </a>
        </li>
        <li>
            <a class="collapsible-header no-col-body waves-effect waves-set" href="{{ url('/admin/status') }}">
                <i class="material-icons">dashboard</i>
                <span>Status</span>
            </a>
        </li>
